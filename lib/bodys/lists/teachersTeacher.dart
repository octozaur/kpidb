...
import '../../navs/comment.dart';
import '../../navs/teacherW.dart';
import '../../data/globals.dart' as globals;
class TeachersTeacher extends StatefulWidget {
  var teacher;
  TeachersTeacher(this.teacher);

  @override
  _TeachersTeacher createState() => _TeachersTeacher(this.teacher);
}



class _TeachersTeacher extends State<TeachersTeacher> {
  var teacher;
  var t;
  var comments;
  var len;
  var isComented = false;
  _TeachersTeacher(this.t);
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: InkWell(
                          onTap: (){if(isComented == false)Navigator.of(context).push(PageRouteBuilder(
                              opaque: false,
                      ...
                      if(t.comments != null)
                        ...t.comments.reversed.map((a){i++; return Comment(t.ratings[i], a);}),
                      Container(
